...
\hline
\textbf{Variable} & \textbf{V b/f} & \textbf{V f/b}  & \textbf{NV b/f} & \textbf{NV f/b}\\ \hline
Intercept & 4.932 & 3.708 & 12.379 & 11.924\\ \hline
\texttt{region} - North East & -0.203 & -0.205 & -0.162 & -0.182\\ \hline
\texttt{region} - West & 0.297 & 0.305 & 0.162 & 0.163 \\ \hline
\texttt{region} - South & 0.247 & 0.243 & 0.015 & 0.006 \\ \hline
\texttt{isUrban} & 0.182 & 0.180 & 0.065 & 0.058\\ \hline
\texttt{pctWdiv} & -0.013 & -0.014 & 0.005 & 0.005 \\ \hline
\texttt{pctNotHSgrad} & N/A & N/A & -0.084 & N/A \\ \hline
\texttt{pctCollGrad} & N/A & N/A & N/A & 0.112 \\ \hline
\texttt{pctLowEdu} & 0.076 & 0.093 & 0.164 & 0.087\\ \hline
\texttt{pctEmploy} & N/A & N/A & 0.009 & 0.009 \\ \hline
\texttt{pctKids2Par} & -0.033 & -0.035 & -0.030 & -0.029\\ \hline
\texttt{pctKidsBornNevrMarr} & 0.737 & 0.680 & N/A & N/A \\ \hline
\texttt{pctHousOccup} & 0.000 & 0.000 & 0.000 & 0.000 \\ \hline
\texttt{pctHousOwnerOccup} & 0.002 & N/A & N/A & N/A \\ \hline
\texttt{pctVacantBoarded} & 0.110 & 0.108 & 0.045 & 0.041 \\ \hline
\texttt{pctVacant6up} & -0.003 & -0.002 & -0.003 & -0.003 \\ \hline
\texttt{medIncome} & N/A & 0.215 & N/A & N/A \\ \hline
\texttt{rentMed} & 0.289 & 0.186 & N/A & N/A \\ \hline
\texttt{rentQrange} & 0.123 & 0.114 & -0.092 & -0.101  \\ \hline
\texttt{ownHousMed} & N/A & N/A & -0.258 & -0.172 \\ \hline
\texttt{ownHousQrange} & N/A & N/A & 0.085 & N/A \\ \hline
\texttt{popDensity} & N/A & N/A & 0.043 & 0.040 \\ \hline
\texttt{pctForeignBorn} & 0.057 & 0.056 & 0.081 & 0.076 \\ \hline
\end{tabular}
\end{center}
\fontsize{11}{11} \selectfont

With both models having the same number of parameters (in the case of violent crime), we decided to choose the model with the lower AIC value, which corresponds to the model with the lower mean squared error, violentModelAICMin (AIC value of 3505.804). With nonViolModelAICMin having a lower AIC value 1523.04 and lower number of parameters, it is our chosen model. Both of these produced better AIC values than our EDA produced benchmark.
...
Figure 14 - Boxplot of errors across states (Violent Crime)
...
Figure 15 - Boxplot of errors across states (Non-Violent Crime)
```{r, eval=FALSE, fig.height = 3.5}
USACrime3 = USACrime2[c(-320,-363,-1548),]
